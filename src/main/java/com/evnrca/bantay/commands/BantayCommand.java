    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (subCommand) {
            ...
            case "bypass":
                ...
                // Toggle bypass by adding/removing permission
                // Since we can't easily remove permissions at runtime without a permission plugin,
                // we'll just inform the user to use a permission plugin for persistent bypass
